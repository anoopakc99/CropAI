...
<div class="container-fluid">
    <div class="main-containerr" style="margin-top: 10px;">
        ...
        <div class="header">
            ...
            <h4> Add New Contract Farming</h4>
        ...
        <div class="form-container">
            ...
            <form method="POST" action="{{ route('contact-farming.store') }}" enctype="multipart/form-data" class="needs-validation">
                @csrf
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="seed_name" class="form-control" value="{{ old('seed_name.0') }}" required>
                                        @error('seed_name.0')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                           ...
                           <div class="variety-row border border-success rounded p-3 mb-3">
                                <div class="row mb-3">
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="variety[]" class="form-control" value="{{ old('seed_name.0') }}" required>
                                        @error('seed_name.0')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number"
                                                   ...
                                                   class="form-control production-price"
                                                   step="0.01"
                                                   required
                                                   onchange="calculateRowAmounts(this)"
                                                   value="{{ old('production_price.0') }}">
                                            <span class="input-group-text">MT</span>
                                        </div>
                                        @error('production_price.0')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                     <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number"
                                                   name="product_amount[]"
                                                   class="form-control auto-calc product-amount"
                                                   readonly
                                                   value="{{ old('product_amount.0') }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                      <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number"
                                                   name="handling_loss[]"
                                                   class="form-control handling-loss"
                                                   step="0.01"
                                                   placeholder="0.00"
                                                   onchange="calculateRowAmounts(this)"
                                                   value="{{ old('handling_loss.0') }}">
                                            <span class="input-group-text">MT</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number"
                                                   ...
                                                   class="form-control amount-recovery"
                                                   step="0.01"
                                                   placeholder="0.00"
                                                   onchange="calculateRowAmounts(this)"
                                                   value="{{ old('amount_recovery.0') }}">
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number"
                                                   name="remaining_sale_quantity[]"
                                                   class="form-control auto-calc remaining-sale-quantity"
                                                   step="0.01"
                                                   readonly
                                                   value="{{ old('remaining_sale_quantity.0') }}">
                                            <span class="input-group-text">MT</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="sale-details-container">
                                    <div class="section-header d-flex justify-content-between align-items-center mt-3 mb-3">
                                        <div style="font-size: 0.9rem;">
                                            <i class="fas fa-shopping-cart"></i> Sale Entries
                                        </div>
                                        ...
                                        <div class="sale-entry border border-info rounded p-3 mb-2 position-relative">
                                            <div class="row mb-3">
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number"
                                                               name="sales[0][quantity_sold_actual][]"
                                                               class="form-control quantity-sold-actual"
                                                               step="0.01"
                                                               required
                                                               onchange="calculateRowAmounts(this)"
                                                               value="{{ old('sales.0.quantity_sold_actual.0') }}">
                                                        <span class="input-group-text">MT</span>
                                                    </div>
                                                    @error('sales.0.quantity_sold_actual.0')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-text">₹</span>
                                                        <input type="number"
                                                               name="sales[0][sale_price][]"
                                                               class="form-control sale-price"
                                                               step="0.01"
                                                               required
                                                               onchange="calculateRowAmounts(this)"
                                                               value="{{ old('sales.0.sale_price.0') }}">
                                                        <span class="input-group-text">MT</span>
                                                    </div>
                                                    @error('sales.0.sale_price.0')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-text">₹</span>
                                                        <input type="number"
                                                               name="sales[0][total_sale_amount][]"
                                                               class="form-control auto-calc total-sale-amount"
                                                               readonly
                                                               value="{{ old('sales.0.total_sale_amount.0') }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="form-label">Buyer Name <span class="required">*</span></label>
                                                    <input type="text"
                                                           name="sales[0][sale_part_to][]"
                                                           class="form-control"
                                                           required
                                                           value="{{ old('sales.0.sale_part_to.0') }}">
                                                    @error('sales.0.sale_part_to.0')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            </div>
...
<script>
    ...
    const selectedPlotIds = Array.from(document.querySelectorAll('.plot-checkbox:checked'))
        .map(cb => cb.value);
...
function updateFinancialSummary(productionAmount, recoveryAmount, saleAmount) {
    ...
    let varietyIndex = 0; // To keep track of variety rows for naming inputs
    ...
    function calculateRowAmounts(input) {
        ...
        varietyRow.querySelectorAll('.sale-entry').forEach(saleEntry => {
        ...
        if (totalSoldQuantityForVariety > saleQtyByProduction) {
