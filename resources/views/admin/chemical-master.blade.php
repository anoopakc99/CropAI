...
<div class="d-flex align-items-center mt-4">
    @if(Auth::check() && Auth::user()->role != 1)
    <form method="GET" action="{{ route('chemicals.index') }}" class="input-group shadow-sm rounded-pill w-25">
...
<div class="modal fade" id="addChemicalModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="{{ route('master-chemical.store') }}" method="POST">
                @csrf
...
<div class="modal fade" id="editChemicalModal{{ $chemical->id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="{{ route('chemical-master.update', $chemical->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="modal-header">
