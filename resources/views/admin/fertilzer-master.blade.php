    ...
    <form method="GET" action="{{ route('master-fertilizer.index') }}">
        <div class="row align-items-end">
            ...
            <div class="col-md-4">
                ...
                <a href="{{ route('fertilizers.index') }}" class="btn btn-secondary">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="d-flex justify-content-center gap-2">
                    ...
                    <!--<form action="{{ route('fertilizers.destroy', $fertilizer->id) }}" method="POST">-->
                    <!--    @csrf-->
                    <!--    @method('DELETE')-->
...
<!-- Edit Modal -->
@if(Auth::check() && Auth::user()->role != 1)
@foreach($paginatedFertilzers as $fertilizer)
