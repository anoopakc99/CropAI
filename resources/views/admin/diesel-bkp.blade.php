...
@endif
    ...
    <!-- <h4 class="mt-5">Monthly Diesel Summary</h4>
    <div class="table-responsive">
        <table class="table table-bordered">
            <thead class="bg-secondary text-white">
                <tr>
                    <th>Month</th>
                    <th>Total Diesel In</th>
                    <th>Total Diesel Out</th>
                    <th>Balance</th>
                </tr>
            </thead>
            <tbody>
    ...
    <h4 class="mt-5">ðŸ§¾ Diesel In Consumption Report (FIFO)</h4>
    <div class="table-responsive">
        <table class="table table-bordered">
            ...
            <tbody>
                @forelse($consumptionReport as $i => $record)
                <tr>
                    <td>{{ $i + 1 }}</td>
                    <td>{{ \Carbon\Carbon::parse($record['date_in'])->format('d-m-Y') }}</td>
                    <td>{{ $record['stock_in'] }}</td>
                    <td>{{ $record['used'] }}</td>
                    <td>{{ $record['date_zero'] ?? '-' }}</td>
                    <td>{{ $record['stock_in'] - $record['used'] }}</td>
                    <td>{{ $record['rate'] ?? '-' }}</td>
                    <td>{{ $sites->firstWhere('id', $record['site'])->site_name ?? 'N/A' }}</td>
                </tr>
                @empty
                <tr>
                    <td colspan="8">No consumption report available.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
...
<div class="ticket-dashboard-section mt-5">
    <div class="row g-3 mb-4 align-items-stretch">
        ...
        <div class="col-lg-6 col-md-12 d-flex flex-column h-100">
            <div class="d-flex flex-column h-100 justify-content-between" style="height:100%; min-height:340px;">
                    ...
                    <div class="flex-fill p-2">
                        <div class="card ticket-compact-card text-center shadow-sm h-100 d-flex flex-column justify-content-center align-items-center">
                            <div class="card-body d-flex flex-column justify-content-center align-items-center h-100">
                                ...
                                <h3 class="fw-bold text-info">1,250</h3>
                            </div>
                        </div>
                    </div>
                    <div class="flex-fill p-2">
                        <div class="card ticket-compact-card text-center shadow-sm h-100 d-flex flex-column justify-content-center align-items-center">
                            <div class="card-body d-flex flex-column justify-content-center align-items-center h-100">
                                ...
                                <h6 class="mb-1">Total HSD Consumed/Day</h6>
                ...
                <div class="d-flex flex-row flex-fill" style="height:50%;">
                    <div class="flex-fill p-2">
                        <div class="card ticket-compact-card text-center shadow-sm h-100 d-flex flex-column justify-content-center align-items-center">
                            <div class="card-body d-flex flex-column justify-content-center align-items-center h-100">
                                ...
                                <h6 class="mb-1">Total Available HSD</h6>
                    ...
                    <div class="flex-fill p-2">
                        <div class="card ticket-compact-card text-center shadow-sm h-100 d-flex flex-column justify-content-center align-items-center">
                            <div class="card-body d-flex flex-column justify-content-center align-items-center h-100">
                                <div class="mb-2"><i class="fas fa-rupee-sign fa-2x text-primary"></i></div>
                                <h6 class="mb-1">Total Cost Of the HSD</h6>
                                <h3 class="fw-bold text-primary">₹1,12,500</h3>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Right: Tall chart card, exactly half width -->
        <div class="col-lg-6 col-md-12 d-flex flex-column h-100">
            <div class="card shadow-sm h-100 d-flex flex-column justify-content-center align-items-center ticket-graph-card" style="height:100%; min-height:280px; padding: 0.7rem 0.5rem;">
                <h6 class="mb-2 text-center" style="font-size:1rem;">Activities wise HSD Consumption</h6>
                <!-- Remove the custom legend from the pie chart card -->
                <div class="d-flex flex-column flex-md-row justify-content-center align-items-center w-100" style="min-height:280px; min-width:480px;">
                    <canvas id="freshPieChart" width="480" height="280" style="max-width:100%; max-height:320px;"></canvas>
                </div>
            </div>
        </div>
    </div>
