...
<div class="table-responsive">
            ...
            @forelse ($data as $index => $item)
                ...
                @php
                   ...
                   if (is_string($item->category_id)) {
                        $categories = json_decode($item->category_id, true);
                    } else {
                    ...
                    // Skip this row if session filter is applied and doesn't match
                ...
                <tr>
                    ...
                    <!--    </span>-->
                    <!--</td>-->
                    <td style="white-space: nowrap;">{{ $item->date ? \Carbon\Carbon::parse($item->date)->format('d-m-Y') : '--' }}</td>
    ...
    @endforelse
                    ...
                    <td>{{ $item->semi_skilled_1 }}</td>
                    <td>{{ $item->semi_skilled_2 }}</td>
                    @php
