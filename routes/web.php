...
use App\Http\Controllers\AiCropHealthController;



Route::get('/smart-dairy', [LoginController::class, 'SmartDairy']);
Route::get('/welcome-page', [LoginController::class, 'welcomepage']);
//==================================================================================================================================
...
Route::middleware(['auth', 'role:1'])->group(function () {
    ...
    // AI Crop Health Dashboard (all plots in one page)
    Route::get('/ai-crop-health', [AiCropHealthController::class, 'index'])->name('ai-crop-health.index');
    Route::get('/ai-crop-health-all', [AiCropHealthController::class, 'allPlotsSummary'])->name('api.ai-crop-health-all');
    Route::get('/ai-crop-health-geojson', [AiCropHealthController::class, 'plotsGeoJSON'])->name('api.ai-crop-health-geojson');
    Route::get('/ai-crop-health-dates', [AiCropHealthController::class, 'scanDates'])->name('api.ai-crop-health-dates');
    Route::get('/ai-crop-health-insight/{plot_id}', [AiCropHealthController::class, 'aiInsight'])->name('api.ai-crop-health-insight');
    Route::get('/ai-crop-health/{plot_id}', [AiCropHealthController::class, 'plotData'])->name('api.ai-crop-health');
